...
//
//  Created by Liam Flaherty on 3/6/19.
...
class Paladin : Classes {
   ...
   // var rageDamange = 2
    ...
    enum palPath : String, CaseIterable{
    ...
    func levelPath(path : palPath){
        switch(path){
            
        //before doing any stupid stuff you'll regret as you have to spend 20 hours making it better just make sure you figure out a STRUCT that will work with everything here
        case .ANCIENTS :
